...
ctr.contact_state_val = repmat([repmat([1;0;0;1], 1, ctr.contact_state_ratio(1)),...
                         repmat([0;1;1;0], 1, ctr.contact_state_ratio(1))],1,ctr.gait_num/2)
                 
% cost gains
ctr.weight.QX = [10 10 10, 1000 10 1000, 10 10 10, 1000 10 10 ]'; % state error
