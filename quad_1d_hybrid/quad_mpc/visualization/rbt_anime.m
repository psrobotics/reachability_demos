...
for k = 1:len-1
    ...
    % foot
    plot3(fp_w_1(1),fp_w_1(2),fp_w_1(3),'o','linewidth',2,'color','b','markersize',4);
    plot3(fp_w_2(1),fp_w_2(2),fp_w_2(3),'o','linewidth',2,'color','b','markersize',4);

    plot3(fp_w_3(1),fp_w_3(2),fp_w_3(3),'o','linewidth',2,'color','b','markersize',4);
    plot3(fp_w_4(1),fp_w_4(2),fp_w_4(3),'o','linewidth',2,'color','b','markersize',4);

    % hip
    plot3(hip_g_fr(1),hip_g_fr(2),hip_g_fr(3),'o','linewidth',2,'color','b','markersize',4);
    plot3(hip_g_fl(1),hip_g_fl(2),hip_g_fl(3),'o','linewidth',2,'color','b','markersize',4);

    plot3(hip_g_br(1),hip_g_br(2),hip_g_br(3),'o','linewidth',2,'color','b','markersize',4);
    plot3(hip_g_bl(1),hip_g_bl(2),hip_g_bl(3),'o','linewidth',2,'color','b','markersize',4);
